        ...
        <div class="portlet box blue">
             ...
             <div class="portlet-body ">
                 <div class="dd" id="nestable_list_2">
                    <ol class="dd-list">
                    <?php foreach ($edit_result as $key => $value): ?>                                
                        <li class="dd-item" data-id="<?=$value['id']?>">
                            <div class="dd-handle" style="height:auto">
                                <div class="media">
                                  <a class="pull-left" href="#">
...
<div class="row">
    <div class="col-md-12 text-center">
        <button type="button" onclick="saveMultNews()" class="btn btn-block btn-success">保存</button>       
        <input id="old_ids" type="hidden" name="old_ids" value="">
    </div>
</div>
...
function saveMultNews(){
    ...
    if(jsonData.length > 1){    
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {ids: data, old_ids: window.JSON.stringify(old_ids)},
...
$(function () {
    ...
    //初始化数据
    $('#nestable_list_2').data('output', window.JSON.stringify($('#nestable_list_2').nestable('serialize')));
    old_ids = $('#nestable_list_2').nestable('serialize');
})
