<div class="portlet box green">
    ...
    <div class="portlet-body form">
        <form id='editForm' class="form-horizontal" action="<?php echo site_url($controller_url."news_save")?>">
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-3 control-label">标题</label>
                    <div class="col-md-4">
                        <input class="form-control" type='text' name="title" value='<?=$row['title']?>' datatype="*"/>
                    </div>
                </div>
                <div class="form-group">
