...
<li class="start open">
	...
	<ul class="sub-menu" style="display:block">
		...
		<li><a id="roles_view" class="ajaxify" href="<?php echo site_url('admin/sys/')?>" target="right">系统配置</a></li>
		<?php endif;?>
		...
		<li><a id="sys_view" class="ajaxify" href="<?php echo site_url('admin/user_admin/roles')?>" target="right">后台用户角色管理</a></li>
		<?php endif;?>		
	</ul>
</li>
<?php endif;?>