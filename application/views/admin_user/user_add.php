        ...
        <form id='user_add' class="form-horizontal" action="<?php echo site_url('admin/user_admin/user_add_save')?>">
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" type='text' name="username" value='' datatype="*" ajaxurl="admin/user_admin/username_check" sucmsg="用户名验证通过！" nullmsg="请输入用户名！" errormsg="请用邮箱或手机号码注册！"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group last">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" type='text' name='profile[email]' value='' />
                    </div>
                </div>
            </div>
