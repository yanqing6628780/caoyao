...
<div class="modal-body">
	...
	<div class="row">
		<div class="col-md-3">		
			<h3><small>数量:</small><span id="rel_total_qty" class="text-danger">0</span></h3>
		</div>
		<div class="col-md-3">	
			<h3><small>合计:</small><span id="rel_total" class="text-danger">0</span></h3>
		</div>
	</div>
</div>
<div class="modal-footer">
	<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
	<button id="rel_save_order" type="button" class="btn btn-primary">保存订单</button>
...
$(function () {
	var $inputs = $('#rel_good_form').find('.spinner-input');
	var $total_qty = $('#rel_total_qty');
	var $total = $('#rel_total');
	...
	$('#rel_save_order').click(function(event) {
		var data = $('#rel_good_form').serialize();
		$.ajax({
	        type: "POST",
