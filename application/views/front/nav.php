    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" style="height: 1px;">
            ...
            <div class="collapse navbar-collapse navbar-left">
                ...
                <a data-trigger="ajax" href="<?=site_url('orders')?>" data-target="#main" class="btn btn-info navbar-btn" type="button"><span class="glyphicon glyphicon-list-alt"></span>我的订单</a>                
            </div>
            <form id="search" role="search" class="navbar-form navbar-right">
