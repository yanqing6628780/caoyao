    ...
    <div class="portlet-body form">
        <form id='addForm' class="form-horizontal" action="<?php echo site_url($controller_url."add_save")?>">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 col-md-3 control-label">表名</label>
                    <div class="col-md-4">
                        <input class="form-control" type='text' name="table" value='' ajaxurl="<?=site_url('admin/category/check')?>" datatype="*" />
                    </div>
                </div>
            </div>
